...
This suggests that GPT-3 uses a consistent attention pattern to solve the task. 

We hope to reverse-engineer this attention pattern and make it human-interpretable. 
