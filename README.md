...
We generate evidence that GPT-3 consistently solves the LEGO reasoning task with the same attention pattern. We hope to reverse-engineer this attention pattern and make it human-interpretable.
